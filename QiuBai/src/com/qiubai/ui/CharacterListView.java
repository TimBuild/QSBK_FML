...
public class CharacterListView extends ListView implements OnScrollListener{
	...
	//	setCacheColorHint(context.getResources().getColor(R.color.detail_activity_bg_color));
		...
		headView = inflater.inflate(
				R.layout.fragment_character_listview_head, null);
		...
		footerView =  inflater.inflate(R.layout.fragment_character_listview_footer, null);
